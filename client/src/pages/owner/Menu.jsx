   ...
   <>
     ...
     <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
       <div>
         ...
         <p className="mt-1 text-gray-500">Manage your restaurant food items</p>
       </div>

       <Link
         to="/owner/menu/create"
         className="flex items-center justify-center gap-2 rounded-xl bg-orange-500 px-5 py-3 text-white hover:bg-orange-600"
       >
         <Plus size={18} />
         Add Food
       </Link>
     ...
     {foods.length === 0 ? (
       ...
       <>
                   ...
                   <td className="p-4">
                     <div className="flex justify-center gap-3">
                       <Link
                         ...
                         className="rounded-lg border border-orange-500 bg-white p-2 text-orange-500 hover:bg-orange-500 hover:text-white"
                       >
                         <Pencil size={18} />
                       </Link>
         ...
         <div className="grid gap-5 md:hidden">
           {foods.map((food) => (
             <div key={food._id} className="rounded-xl bg-white p-4 shadow">
               <img
               ...
               <div className="mt-4 flex gap-3">
                 <Link
                   to={`/owner/menu/edit/${food._id}`}
                   className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-orange-500 py-3 text-white"
                 >
                   <Pencil size={18} />
                   Edit
                 </Link>
                 ...
                 <button
                   onClick={() => handleDelete(food._id)}
                   className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-red-500 py-3 text-white"
                 >
                   <Trash2 size={18} />
                   Delete
                 </button>
