    ...
    <div className="overflow-hidden rounded-xl bg-white shadow">
      ...
      <div className="relative p-4 sm:p-8">
        ...
        <img
          ...
          className="absolute -top-16 left-1/2 h-32 w-32 -translate-x-1/2 rounded-full border-4 border-white object-cover shadow-lg sm:left-8 sm:translate-x-0"
        />

        {/* Header */}
        <div className="mt-20 flex flex-col gap-6 sm:ml-40 sm:mt-0 sm:flex-row sm:items-center sm:justify-between">
          <div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <Link
              ...
              className="flex items-center justify-center gap-2 rounded-lg bg-orange-500 px-5 py-3 text-white hover:bg-orange-600"
            >
              <Pencil size={18} />
              Edit
            </Link>
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-lg border border-red-500 bg-white px-5 py-3 text-red-500 hover:bg-red-500 hover:text-white"
            >
              <Trash2 size={18} />
              Delete
            </button>
