    ...
    <div>
      ...
      <div className="space-y-8">
        {orders.map((order) => (
          ...
          >
            {/* Order Header */}
            <div className="flex items-center justify-between border-b bg-orange-50 px-8 py-5">
              <div>
            ...
            {order.status === "picked" && (
              <div className="border-t bg-orange-50 p-6">
                <RiderLocationTracker orderId={order._id} />
              </div>
            )}

            {/* Action Buttons */}
            <div className="flex gap-4 border-t bg-gray-50 p-6">
              {/* Accept / Decline */}
